...
if uploaded_file:
    ...
    # --- ČIŠTĚNÍ: Odstranění řádků, kde 'Název' je prázdný nebo obsahuje "Celkem" ---
    # Přeskočíme řádky, kde v sloupci 'Název' není platná hodnota
    df = df[df['Název'].notna()]
    df = df[df['Název'] != 'Celkem']
    ...
    # Aplikace čištění na tvé konkrétní názvy sloupců
